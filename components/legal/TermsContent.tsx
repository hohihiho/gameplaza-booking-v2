export default function TermsContent() {
  return (
    <div className="prose prose-gray dark:prose-invert max-w-none">
      ...
      <p>
        광주 게임플라자(이하 "회사")가 제공하는 게임기기 예약 서비스(이하 "서비스")를 이용함에 있어 
      ...
      <h3>제1조 (목적)</h3>
      <p>
        이 약관은 광주 게임플라자가 제공하는 게임기기 예약 서비스를 이용함에 있어 
        회사와 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
      </p>
      ...
      <h3>제18조 (개인정보보호)</h3>
      <p>
        회사는 회원의 개인정보를 보호하기 위하여 관련 법령이 정하는 바를 준수하며, 
        개인정보의 보호 및 사용에 대해서는 관련법령 및 회사의 개인정보처리방침을 적용합니다.
      </p>
      ...
      <h3>제22조 (약관의 시행)</h3>
      <p>
        이 약관은 <strong>2025년 8월 15일</strong>부터 시행됩니다.
      </p>
    </div>
  );
}