...
export const KOREAN_PROFANITY_PATTERNS = [
  // 기본 비속어
  { pattern: '시발', severity: 4 },
  { pattern: '씨발', severity: 4 },
  { pattern: '개새끼', severity: 4 },
  { pattern: '병신', severity: 4 },
  { pattern: '지랄', severity: 3 },
  { pattern: '좆', severity: 4 },
  { pattern: '닥쳐', severity: 3 },
  { pattern: '꺼져', severity: 3 },
  { pattern: '쓰레기', severity: 2 },
  { pattern: '멍청이', severity: 1 },
  { pattern: '바보', severity: 1 },
  { pattern: '미친', severity: 2 },
  { pattern: '또라이', severity: 3 },
  { pattern: '새끼', severity: 3 },
  { pattern: '놈', severity: 1 },
  { pattern: '년', severity: 2 },
  
  // 성적 표현
  { pattern: '섹스', severity: 3 },
  { pattern: '야동', severity: 3 },
  { pattern: '보지', severity: 4 },
  { pattern: '자지', severity: 4 },
  { pattern: '젖', severity: 2 },
  { pattern: '가슴', severity: 1 },
  { pattern: '음경', severity: 3 },
  { pattern: '성기', severity: 3 },
  
  // 폭력적 표현
  { pattern: '죽어', severity: 4 },
  { pattern: '죽여', severity: 4 },
  { pattern: '때려', severity: 3 },
