...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: '/light-favicon.png', sizes: '32x32', type: 'image/png', media: '(prefers-color-scheme: light)' },
      { url: '/dark-favicon.png', sizes: '32x32', type: 'image/png', media: '(prefers-color-scheme: dark)' },
      { url: '/favicon-48x48.png', sizes: '48x48', type: 'image/png' },
      { url: '/light-favicon.png', sizes: '32x32', type: 'image/png' } // 기본 파비콘
    ],
    shortcut: '/light-favicon.png',
